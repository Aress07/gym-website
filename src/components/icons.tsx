...
export function CarIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M4 11h16v5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1H7v1a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-5z" />
...
export function StarIcon({ className }: IconProps) {
  return (
    <svg
      ...
      className={className ?? "h-4 w-4"}
    >
      <path d="M12 2.35l2.985 6.047 6.674.97-4.83 4.707 1.14 6.648L12 17.77l-5.969 3.139 1.14-6.648L2.34 9.367l6.674-.97L12 2.35z" />
    </svg>
  );
}
